...
from scenegraphnav.prompt.geonav import LOCAL_GRPAH_PROMPT
...
class LLMController:
    ...
    def understand(self, image_64: str, epi: Episode):
        ...
        PROMPT = LOCAL_GRPAH_PROMPT.format(objects=[epi.description_target]+epi.description_surroundings)
